...
const PETS = {
  ...
  metal: [
    ...
    { id:'m13', name:'金影刺客',  atk:11, skill:{ name:'金刺', desc:'下回合金属性攻击必定暴击', type:'guaranteeCrit', attr:'metal' }, cd:9 },
  ...
  wood: [
    ...
    { id:'w9',  name:'木灵使者',  atk:10, skill:{ name:'灵心', desc:'3回合内心珠效果翻倍', type:'heartBoost', mul:2, dur:3 }, cd:9 },
  ...
  fire: [
    ...
    { id:'f13', name:'烈阳火鹰',  atk:10, skill:{ name:'烈灵', desc:'触发全队主动攻击，每只宠物造成各自攻击力的伤害', type:'teamAttack' }, cd:9 },
  ...
  earth: [
    ...
    { id:'e14', name:'玄土灵蛤',  atk:11, skill:{ name:'震慑', desc:'【待更换】此技能为法宝技能，后续替换新技能并通过法宝实现', type:'stun', dur:1, chance:20, _pendingRedesign:true }, cd:10 },
    ...
    { id:'e17', name:'后土灵蚕',  atk:9,  skill:{ name:'地脉', desc:'将棋盘所有水珠替换为土珠', type:'replaceBeads', fromAttr:'water', toAttr:'earth' }, cd:10 },
