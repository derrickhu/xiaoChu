...
const PETS = {
  ...
  metal: [
    ...
    { id:'m3',  name:'玄甲金狮',  atk:9,  skill:{ name:'金甲术', desc:'获得护盾25点+本回合免伤30%', type:'shieldPlus', val:25, reducePct:30 }, cd:5 },
    ...
    { id:'m7',  name:'金罡守卫',  atk:9,  skill:{ name:'罡气盾', desc:'获得护盾30点', type:'shield', val:30 }, cd:5 },
  ...
  wood: [
    ...
    { id:'w3',  name:'苍木灵熊',  atk:9,  skill:{ name:'熊力护体', desc:'护盾30点+反弹20%伤害2回合', type:'shieldReflect', val:30, reflectPct:20, dur:2 }, cd:5 },
    ...
    { id:'w11', name:'青藤守卫',  atk:9,  skill:{ name:'藤甲壁垒', desc:'护盾35点+减伤20%持续2回合', type:'shieldPlus', val:35, reducePct:20 }, cd:6 },
    ...
    { id:'w19', name:'万木神龟',  atk:12, skill:{ name:'神龟之力', desc:'血量上限+25%+护盾30点', type:'hpMaxShield', hpPct:25, shieldVal:30 }, cd:7 },
  ...
  water: [
    ...
    { id:'s2',  name:'冰魄灵龟',  atk:9,  skill:{ name:'冰魄铠甲', desc:'护盾30点+免伤35%本回合', type:'shieldPlus', val:30, reducePct:35 }, cd:5 },
    ...
    { id:'s13', name:'玄水灵蟾',  atk:10, skill:{ name:'水盾壁障', desc:'护盾35点', type:'shield', val:35 }, cd:5 },
    ...
    { id:'s16', name:'水镜灵蝶',  atk:11, skill:{ name:'水镜反射', desc:'反弹30%伤害1回合+护盾25', type:'shieldReflect', val:25, reflectPct:30, dur:1 }, cd:5 },
    ...
    { id:'s19', name:'水纹灵獭',  atk:11, skill:{ name:'灵獭水盾', desc:'消除水珠获护盾15点持续2回合', type:'shieldOnElim', attr:'water', val:15, dur:2 }, cd:6 },
    { id:'s20', name:'冰凰神鸟',  atk:11, skill:{ name:'冰凰绝对', desc:'免疫所有控制2回合+护盾30', type:'immuneShield', immuneDur:2, shieldVal:30 }, cd:6 },
  ],
  ...
  // ===== （五）土属性宠物（20只） =====
  earth: [
    { id:'e1',  name:'厚土石灵',  atk:9,  skill:{ name:'厚土护体', desc:'护盾30点+减伤30%本回合', type:'shieldPlus', val:30, reducePct:30 }, cd:5 },
    { id:'e2',  name:'山岳石怪',  atk:9,  skill:{ name:'山岳珠阵', desc:'整行珠子变土珠', type:'convertRow', attr:'earth' }, cd:4 },
    { id:'e3',  name:'镇地石犀',  atk:10, skill:{ name:'镇地壁垒', desc:'获得护盾40点', type:'shield', val:40 }, cd:6 },
    ...
    { id:'e13', name:'镇地石龙',  atk:11, skill:{ name:'镇地龙盾', desc:'护盾35点+护盾效果+30%', type:'shield', val:35, bonusPct:30 }, cd:6 },
    { id:'e14', name:'玄土灵蛤',  atk:12, skill:{ name:'蛤蟆震地', desc:'眩晕1回合+破甲（防御归零）', type:'stunBreakDef', stunDur:1 }, cd:4 },
    { id:'e15', name:'裂地灵蚁',  atk:11, skill:{ name:'灵蚁护盾', desc:'消除土珠获护盾18点持续2回合', type:'shieldOnElim', attr:'earth', val:18, dur:2 }, cd:6 },
    ...
    { id:'e19', name:'厚土灵龟',  atk:11, skill:{ name:'仙龟铁壁', desc:'血量上限+25%+护盾40点', type:'hpMaxShield', hpPct:25, shieldVal:40 }, cd:7 },
