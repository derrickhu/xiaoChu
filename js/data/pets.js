...
const PETS = {
  ...
  metal: [
    ...
    { id:'m7',  name:'金罡守卫',  atk:9,  skill:{ name:'罡气吞木', desc:'全部木珠转为金珠', type:'replaceBeads', fromAttr:'wood', toAttr:'metal' }, cd:4 },
    ...
    { id:'m12', name:'金纹战将',  atk:11, skill:{ name:'金纹化木', desc:'全部木珠转金珠+金伤+30%', type:'replaceBeads', fromAttr:'wood', toAttr:'metal', dmgBoost:30 }, cd:5 },
  ...
  wood: [
    ...
    { id:'w3',  name:'苍木灵熊',  atk:9,  skill:{ name:'熊力夺土', desc:'全部土珠转为木珠', type:'replaceBeads', fromAttr:'earth', toAttr:'wood' }, cd:4 },
    ...
    { id:'w9',  name:'木灵使者',  atk:11, skill:{ name:'灵木滋生', desc:'下回合木珠出现概率大增', type:'beadRateUp', attr:'wood' }, cd:3 },
    ...
    { id:'w14', name:'苍蟒木蛟',  atk:11, skill:{ name:'蛟龙木爆', desc:'下次木属性伤害×2倍', type:'dmgBoost', attr:'wood', pct:100 }, cd:3 },
  ...
  water: [
    ...
    { id:'s2',  name:'冰魄灵龟',  atk:9,  skill:{ name:'冰魄灭火', desc:'全部火珠转为水珠', type:'replaceBeads', fromAttr:'fire', toAttr:'water' }, cd:4 },
    ...
    { id:'s19', name:'水纹灵獭',  atk:11, skill:{ name:'灵獭化火', desc:'全部火珠转水珠+水珠概率大增', type:'replaceBeads', fromAttr:'fire', toAttr:'water', beadBoost:true }, cd:5 },
  ...
  // ===== （五）土属性宠物（20只） =====
  earth: [
    { id:'e1',  name:'厚土石灵',  atk:9,  skill:{ name:'厚土吞水', desc:'全部水珠转为土珠', type:'replaceBeads', fromAttr:'water', toAttr:'earth' }, cd:4 },
    ...
    { id:'e15', name:'裂地灵蚁',  atk:11, skill:{ name:'灵蚁化水', desc:'全部水珠转土珠+土珠概率大增', type:'replaceBeads', fromAttr:'water', toAttr:'earth', beadBoost:true }, cd:5 },
    { id:'e16', name:'山岩石象',  atk:11, skill:{ name:'象踏碎甲', desc:'眩晕1回合+破甲（防御减半）', type:'stunBreakDef', stunDur:1 }, cd:5 },
    ...
    { id:'e19', name:'厚土灵龟',  atk:11, skill:{ name:'灵龟镇水', desc:'全部水珠转土珠+全队防御+20%', type:'replaceBeads', fromAttr:'water', toAttr:'earth', defBoost:20 }, cd:6 },
