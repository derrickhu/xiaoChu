...
const PETS = {
  ...
  metal: [
    ...
    { id:'m7',  name:'金罡守卫',  atk:9,  skill:{ name:'罡气盾', desc:'获得护盾15点', type:'shield', val:15 }, cd:3 },
    ...
    { id:'m13', name:'金影刺客',  atk:12, skill:{ name:'致命金刺', desc:'必定暴击+暴击伤害+50%', type:'guaranteeCrit', attr:'metal', critDmgBonus:50 }, cd:4 },
  ...
  wood: [
    ...
    { id:'w2',  name:'藤萝灵蛇',  atk:8,  skill:{ name:'剧毒蛇牙', desc:'剧毒：每回合25点，持续3回合', type:'dot', dmg:25, dur:3 }, cd:4 },
    { id:'w3',  name:'苍木灵熊',  atk:9,  skill:{ name:'熊力护体', desc:'护盾20点+反弹20%伤害2回合', type:'shieldReflect', val:20, reflectPct:20, dur:2 }, cd:5 },
    { id:'w4',  name:'万木灵狐',  atk:9,  skill:{ name:'万木化珠', desc:'整列珠子变木珠', type:'convertCol', attr:'wood' }, cd:4 },
    { id:'w5',  name:'灵木仙子',  atk:10, skill:{ name:'生生不息', desc:'每回合回血25点，持续3回合', type:'dot', dmg:-25, dur:3, isHeal:true }, cd:4 },
    { id:'w6',  name:'青木战灵',  atk:11, skill:{ name:'木灵爆发', desc:'下次木属性伤害×2.5倍', type:'dmgBoost', attr:'wood', pct:150 }, cd:3 },
    { id:'w7',  name:'缠枝藤君',  atk:10, skill:{ name:'缠枝锁魂', desc:'敌人眩晕2回合+中毒18/回合', type:'stunDot', dur:2, dotDmg:18, dotDur:3 }, cd:5 },
    ...
    { id:'w11', name:'青藤守卫',  atk:9,  skill:{ name:'藤甲壁垒', desc:'护盾30点+减伤20%持续2回合', type:'shieldPlus', val:30, reducePct:20 }, cd:7 },
    ...
    { id:'w19', name:'万木神龟',  atk:12, skill:{ name:'神龟之力', desc:'血量上限+20%+护盾25点', type:'hpMaxShield', hpPct:20, shieldVal:25 }, cd:7 },
  ...
  water: [
    ...
    { id:'s2',  name:'冰魄灵龟',  atk:9,  skill:{ name:'冰魄铠甲', desc:'护盾18点+免伤30%本回合', type:'shieldPlus', val:18, reducePct:30 }, cd:4 },
    ...
    { id:'s13', name:'玄水灵蟾',  atk:10, skill:{ name:'水盾壁障', desc:'护盾22点', type:'shield', val:22 }, cd:5 },
    ...
    { id:'s16', name:'水镜灵蝶',  atk:11, skill:{ name:'水镜反射', desc:'反弹30%伤害1回合+护盾15点', type:'shieldReflect', val:15, reflectPct:30, dur:1 }, cd:4 },
    ...
    { id:'s19', name:'水纹灵獭',  atk:11, skill:{ name:'灵獭水盾', desc:'消除水珠获护盾10点持续2回合', type:'shieldOnElim', attr:'water', val:10, dur:2 }, cd:5 },
    { id:'s20', name:'冰凰神鸟',  atk:11, skill:{ name:'冰凰绝对', desc:'免疫所有控制2回合+护盾20点', type:'immuneShield', immuneDur:2, shieldVal:20 }, cd:6 },
  ],
  ...
  fire: [
    ...
    { id:'f4',  name:'炎狱火麟',  atk:11, skill:{ name:'炎狱暴击', desc:'必暴击+暴击伤害+50%', type:'guaranteeCrit', critDmgBonus:50 }, cd:4 },
    { id:'f5',  name:'爆炎火蟾',  atk:10, skill:{ name:'烈焰灼烧', desc:'灼烧：每回合30点持续3回合', type:'dot', dmg:30, dur:3 }, cd:4 },
    ...
    { id:'f14', name:'火凰灵蝶',  atk:12, skill:{ name:'凰翼爆炎', desc:'暴击伤害+40%+必暴击1回合', type:'critDmgUp', pct:40, guaranteeCrit:true }, cd:5 },
    { id:'f15', name:'炎爆火鼠',  atk:12, skill:{ name:'炎爆裂天', desc:'眩晕2回合+火伤×3倍', type:'stunPlusDmg', attr:'fire', pct:200, stunDur:2 }, cd:5 },
    { id:'f16', name:'焚天火蟒',  atk:14, skill:{ name:'天火焚灭', desc:'500%火属性爆裂伤害+灼烧', type:'instantDmgDot', attr:'fire', pct:500, dotDmg:25, dotDur:3 }, cd:5 },
  ...
  // ===== （五）土属性宠物（20只） =====
  earth: [
    { id:'e1',  name:'厚土石灵',  atk:9,  skill:{ name:'厚土护体', desc:'护盾15点+减伤25%本回合', type:'shieldPlus', val:15, reducePct:25 }, cd:4 },
    { id:'e2',  name:'山岳石怪',  atk:9,  skill:{ name:'山岳珠阵', desc:'整行珠子变土珠', type:'convertRow', attr:'earth' }, cd:4 },
    { id:'e3',  name:'镇地石犀',  atk:10, skill:{ name:'镇地壁垒', desc:'获得护盾35点', type:'shield', val:35 }, cd:7 },
    ...
    { id:'e13', name:'镇地石龙',  atk:11, skill:{ name:'镇地龙盾', desc:'护盾28点+护盾效果+30%', type:'shield', val:28, bonusPct:30 }, cd:6 },
    { id:'e14', name:'玄土灵蛤',  atk:12, skill:{ name:'蛤蟆震地', desc:'眩晕1回合+破甲（防御归零）', type:'stunBreakDef', stunDur:1 }, cd:4 },
    { id:'e15', name:'裂地灵蚁',  atk:11, skill:{ name:'灵蚁护盾', desc:'消除土珠获护盾12点持续2回合', type:'shieldOnElim', attr:'earth', val:12, dur:2 }, cd:5 },
    ...
    { id:'e19', name:'厚土灵龟',  atk:11, skill:{ name:'仙龟铁壁', desc:'血量上限+20%+护盾35点', type:'hpMaxShield', hpPct:20, shieldVal:35 }, cd:8 },
