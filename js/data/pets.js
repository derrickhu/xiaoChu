...
const PETS = {
  ...
  metal: [
    ...
    { id:'m6',  name:'金光剑灵',  atk:11, skill:{ name:'剑气纵横', desc:'Combo+2，且本次Combo不会断（最多继承10 Combo）', type:'comboPlusNeverBreak', count:2, comboCarryCap:10 }, cd:5 },
  ...
  wood: [
    ...
    { id:'w17', name:'碧玉螳螂',  atk:11, skill:{ name:'螳螂无双', desc:'Combo不断（最多继承10 Combo）+Combo伤害+50%', type:'comboNeverBreakPlus', comboDmgPct:50, comboCarryCap:10 }, cd:5 },
  ...
  water: [
    ...
    { id:'s15', name:'海灵水母',  atk:11, skill:{ name:'水母幻术', desc:'转珠时间+3秒+Combo不断（最多继承8 Combo）', type:'extraTimePlus', sec:3, comboNeverBreak:true, comboCarryCap:8 }, cd:5 },
  ...
  fire: [
    ...
    { id:'f8',  name:'赤炎火蝎',  atk:11, skill:{ name:'炎魔连击', desc:'Combo+4且不会断（最多继承12 Combo）', type:'comboPlusNeverBreak', count:4, comboCarryCap:12 }, cd:6 },
  ...
  earth: [
    ...
    { id:'e14', name:'玄土灵蛤',  atk:12, skill:{ name:'蛤蟆震地', desc:'眩晕1回合+破甲（防御归零，持续1回合）', type:'stunBreakDef', stunDur:1, breakDefPct:100 }, cd:5 },
    ...
    { id:'e16', name:'山岩石象',  atk:11, skill:{ name:'象踏碎甲', desc:'眩晕1回合+易伤20%，持续1回合', type:'stunBreakDef', stunDur:1, extraDmgPct:20 }, cd:4 },
...
const STAR3_SKILL_OVERRIDE = {
  // --- 金属性 ---
  m1:  { desc:'下次金属性伤害×2.5倍，持续2回合', pct:150, dur:2 },
  ...
  m6:  { desc:'Combo+3不断（最多继承12 Combo）+Combo伤害+25%', count:3, comboDmgPct:25, comboCarryCap:12 },
  ...
  m12: { desc:'全部木珠转金珠+金伤+40%', dmgBoost:40 },
  ...
  w17: { desc:'Combo不断（最多继承12 Combo）+Combo伤害+70%', comboDmgPct:70, comboCarryCap:12 },
  ...
  s13: { desc:'冰冻2回合（水伤+30%）+水伤×2.5倍', controlType:'freeze', stunDur:2, pct:150 },
  s14: { desc:'冰冻3回合（水伤+30%）+水伤×3倍', controlType:'freeze', stunDur:3, pct:200 },
  s15: { desc:'转珠+5秒+Combo不断（最多继承10 Combo）+Combo+1', sec:5, bonusCombo:1, comboCarryCap:10 },
  ...
  // --- 火属性 ---
  f1:  { desc:'下次火属性伤害×2.5倍，持续2回合', pct:150, dur:2 },
  ...
  f8:  { desc:'Combo+6不断（最多继承15 Combo）+Combo伤害+25%', count:6, comboDmgPct:25, comboCarryCap:15 },
  ...
  e14: { desc:'眩晕2回合+破甲（防御归零，持续2回合）', stunDur:2, breakDefPct:100 },
  e15: { desc:'全部水珠转土珠+土珠概率大增+土伤+25%', dmgBoost:25 },
  e16: { desc:'眩晕2回合+易伤30%，持续2回合', stunDur:2, extraDmgPct:30 },
...
const STAR5_SKILL_OVERRIDE = {
  // --- 金属性 ---
  m1:  { desc:'下次金属性伤害×3.5倍，持续2回合', pct:250, dur:2 },
...
const PET_LORE = {
  ...
  e16: '山岩石象的幼年体，皮肤坚硬如同岩石。象踏碎甲会震晕敌人并制造破绽，让队伍趁机打出更高伤害。它脾气温顺，对修士非常亲近，喜欢用鼻子卷住修士的手表示亲密——只是力气大了点，经常把人卷起来。',
