...
const ENEMY_SKILLS = {
  ...
  trialDefGuard: { name:'玄甲守势', desc:'防御极高但血量较少，适合用破防突破', type:'buff', field:'def', rate:0.2, dur:2 },
  trialMindGuard:{ name:'定魂无惑', desc:'免疫眩晕与冰冻，攻击偏低', type:'convert', count:3 },
  ...
  trialMindQuake:   { name:'土魇裂甲', desc:'降低修士防御20%,持续2回合', type:'debuff', field:'def', rate:0.2, dur:2 },
  trialSealMetal:   { name:'金锁断刃', desc:'封印1只灵宠，并造成70%攻击力伤害', type:'aoe', atkPct:0.7 },
  trialSealWood:    { name:'木锁缠魂', desc:'封印1只灵宠，并让心珠回复减半2回合', type:'debuff', field:'healRate', rate:0.5, dur:2 },
  trialSealWater:   { name:'水锁乱流', desc:'封印1只灵宠，并随机转换4颗灵珠', type:'convert', count:4 },
  trialSealFire:    { name:'火锁焚阵', desc:'封印1只灵宠，并灼烧2回合', type:'bossDot', atkPct:0.3, dur:2 },
  trialSealEarth:   { name:'土锁压阵', desc:'封印1只灵宠，并随机破坏2颗灵珠', type:'breakBead', count:2 },
}
