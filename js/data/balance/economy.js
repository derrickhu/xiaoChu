...
const DAILY_TASKS = [
  ...
  { id: 'tower_1',     name: '挑战通天塔1次', condition: { type: 'towerRun', count: 1 },   reward: { soulStone: 14 }, unlockStageId: 'stage_1_8' },
  { id: 'trial_1',     name: '挑战天机试炼1次', condition: { type: 'trialRun', count: 1 },  reward: { soulStone: 14 }, unlockStageId: 'stage_1_8' },
