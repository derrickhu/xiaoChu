  ...
  teach: {
    stageCards: {
      ...
      stage_1_2: {
        ...
        note: '拖得越远、排出越多组，连击就越高～',
      },
      stage_1_3: {
        subLabel: '小灵讲堂 · 灵宠搭配',
        title: '珠色 = 灵宠 · 克制翻倍',
        lines: [
          '每只灵宠对应一种珠色，消那个颜色它才出手；',
          '五色灵宠带齐，每一步都有人出力！',
          '这关敌人是水属性 —— 消土珠让土宠攻击，',
          '土克水，伤害 ×1.6！',
        ],
        note: '开战先看敌人属性，优先消克制它的珠色～',
      },
    },

    stageTips: {
      stage_1_4: '主人，这关敌人下手更重 —— 受伤就消粉色心珠回血！',
      stage_1_5: '主人，从灵宠头像上滑一下 —— 放大招的时候到啦！',
      stage_1_6: '练习时间：4 颗同色排成排，伤害 ×1.5，叠上连击更疼！',
      stage_1_7: '主人若能排 5 连，伤害 ×2 还能把敌人晕住～',
      stage_1_8: 'Boss 现身啦！连击、克制、技能，主人全用上吧！',
    },
  },
}
