...
const BUFF_ICON_IMG_MAP = {
  ...
  postBattleHealPct:'assets/ui/battle/buff_icon_heal.png',
  ...
  nextDmgReducePct:'assets/ui/battle/buff_icon_def.png',
...
const BUFF_ICON_EMOJI = {
  ...
  nextDmgReduce:   '\uD83D\uDEE1\uFE0F', nextDmgReducePct:'\uD83D\uDEE1\uFE0F', extraRevive:     '\u267B\uFE0F',
...
const BUFF_CATEGORY = {
  ...
  healNow:'\u751F\u547D\u56DE\u590D', postBattleHeal:'\u751F\u547D\u56DE\u590D', postBattleHealPct:'\u751F\u547D\u56DE\u590D', regenPerTurn:'\u751F\u547D\u56DE\u590D',
  dmgReducePct:'\u9632\u5FA1\u51CF\u4F24', nextDmgReduce:'\u9632\u5FA1\u51CF\u4F24', nextDmgReducePct:'\u9632\u5FA1\u51CF\u4F24', grantShield:'\u9632\u5FA1\u51CF\u4F24', immuneOnce:'\u9632\u5FA1\u51CF\u4F24',
...
const BUFF_LABELS = {
  ...
  nextDmgReduce: '\u4E0B\u51CF', nextDmgReducePct: '\u4E0B\u51CF', grantShield: '\u62A4\u76FE', immuneOnce: '\u514D\u63A7',
  ...
  nextFirstTurnDouble: '\u9996\u56DE\u00D7', healNow: '\u6CBB\u7597', postBattleHeal: '\u6218\u540E', postBattleHealPct: '\u6218\u540E',
}
...
function formatBuffValue(buffKey, val) {
  ...
  if (['healNow','postBattleHeal','postBattleHealPct','grantShield'].includes(buffKey)) return `${val}${buffKey === 'grantShield' ? ' \u70B9\u62A4\u76FE' : '% \u8840\u91CF'}`
