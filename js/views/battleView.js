...
const { drawNewbieFingerGuide, drawNewbieHint, drawNewbieComboBanner, drawFocusBeadGuide } = require('./battle/battleNewbieGuide')
...
function rBattle(g) {
  ...
  // 机制聚焦珠指引（1-3 克制珠 / 1-4 心珠），不依赖新手盘面标记，挑战完成后自动消失
  drawFocusBeadGuide(g, cellSize, boardPad, boardTop)
