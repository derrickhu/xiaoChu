...
const { COMBO_MILESTONES, getComboTier, isComboMilestone, BATTLE_HELP_BTN_BELOW_SAFE_TOP_PT } = require('../data/constants')
...
const { getHelpPageData, getTeamPowerSummary } = require('../engine/strategyAdvisor')
...
// ===== 局内帮助按钮（书卷图标 + "攻略"标签，下移避开微信小程序胶囊栏） =====
...
function _getHelpPages() {
  if (!_helpPagesCache) _helpPagesCache = _buildHelpPages()
...
module.exports = {
  ...
  drawTutorialOverlay,
  get HELP_PAGE_COUNT() { return _getHelpPages().length },
}
